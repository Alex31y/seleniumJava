...
public class Validatore {
    ...
    public void testEnterUsername(){
        try {
            ...
            org.junit.Assert.fail("Failed to enter username");
        }
    }
    ...
    public void testEnterPassword(){
        try {
            ...
            org.junit.Assert.fail("Failed to enter password");
        }
    }
    ...
    public void testClickShowPasswordButton(){
        try {
            ...
            org.junit.Assert.fail("Failed to click Show Password button");
        }
    }
    ...
    public void testClickSignInButton(){
        try {
            ...
            org.junit.Assert.fail("Failed to click Sign In button");
        }
    }
